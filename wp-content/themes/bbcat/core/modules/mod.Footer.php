              ...
              <div class="footer-copy">
				&copy;&nbsp;<?php echo tt_copyright_year(); ?>&nbsp;&nbsp;<?php echo ' ' . get_bloginfo('name') . ' All Right Reserved '; ?>
                    ...
                    echo '·&nbsp;<a href="https://www.miitbeian.gov.cn/" rel="link" target="_blank">' . $beian . '</a>';
					 ...
					 <?php echo '·&nbsp;<b style="color: #ff4425;">♥</b>&nbsp;Theme By <a href="https://www.rogenart.tk" title="BBcat-K" rel="link" target="_blank">BBcat-K</a> & Design By <a href="https://www.rogenart.cf/" title="洛茛艺术" rel="link" target="_blank">洛茛艺术.</a>'; ?>
